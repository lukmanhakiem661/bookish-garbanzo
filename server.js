...
async function startBrowser(data) {
    try {
        ...
        await page.goto('https://colab.research.google.com/drive/1yPop2ncXf_vqHFQInLUVdWcTRE8H60y8', { waitUntil: 'load', timeout: 0 })
        ...
        for (let i = 1; i < 3; i++) {
            ...
            await newPage.goto('https://colab.research.google.com/drive/1yPop2ncXf_vqHFQInLUVdWcTRE8H60y8', { waitUntil: 'load', timeout: 0 })
                ...
                if (block) {
                    ...
                    if (input) {
                        ...
                        if (log == 'START') {
                            ...
                            await PAGES[i].goto('https://colab.research.google.com/drive/1yPop2ncXf_vqHFQInLUVdWcTRE8H60y8', { waitUntil: 'load', timeout: 0 })
